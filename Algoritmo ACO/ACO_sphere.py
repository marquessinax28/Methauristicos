...
# Algoritmo de Optimización por Colonia de Hormigas (ACO) para maximizar la función "sphere"
...
archive_vals = np.array([sphere(x, y) for x, y in archive_X])  # valores de la función objetivo
...
for it in range(1, NUM_ITERACIONES + 1):
    ...
    for a in range(NUM_ANTS):
        ...
        new_sols[a] = sample
        new_vals[a] = sphere(sample[0], sample[1])
